...
def main(host: str, port: int):
    skill = AgentSkill(
        ...
        description="A simple greeting agent that responds with hello world messages",
        tags=["hello", "world", "agent", "greeting"],
        examples=["Say hello to me", "Greet me with a hello world message"],
    )
